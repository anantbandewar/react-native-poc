        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{ backgroundColor: 'white', height: '70%' }}>
                ...
                <ScrollView>
                    ...
                    <View>
                        <LoadStopItemview stop={load.stops[0]} isEditable={false} />
                        <LoadStopItemview stop={load.stops[1]} isEditable={false} />
                    </View>
                    <View style={styles.padding_10}>
                        <SimpleCard style={styles.padding_10}>
                            <View style={styles.actionContainer}>
                                <Button style={styles.actionButton} color={Colors.danger} title="REJECT" />
                                <Button style={styles.actionButton} color={Colors.primary} title="ACCEPT" />
                            </View>
                        </SimpleCard>
                    </View>
                </ScrollView>
